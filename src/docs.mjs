...
\`\`\`sh
npx --yes github:marcusmfrancis/skills#v0.2.0 list
\`\`\`

Install globally for Codex:

\`\`\`sh
npx --yes github:marcusmfrancis/skills#v0.2.0 install mf-ui-taste --global --agent codex
\`\`\`
...
\`\`\`sh
npx --yes github:marcusmfrancis/skills#v0.2.0 install mf-ui-taste --dest .agents/skills
\`\`\`
...
[Download ZIP](https://github.com/marcusmfrancis/skills/archive/refs/tags/v0.2.0.zip) · [MCP setup](docs/MCP.md)
