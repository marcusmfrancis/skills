---
name: mf-agent-article-prompts-to-skills
...
5. If the source is raw HTML and the prompts do not exist yet, use `$mf-agent-html-to-interaction-prompts` first, then return here.
