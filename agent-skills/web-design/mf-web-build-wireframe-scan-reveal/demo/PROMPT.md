...
```text
Use $mf-web-build-wireframe-scan-reveal to introduce this Three.js form with a topology cage that reaches each region before the solid surface.
```

## Recreate the demo

Use `$mf-web-build-wireframe-scan-reveal` to recreate **Sylva — Survey Pulse** as a standalone local HTML demo.
