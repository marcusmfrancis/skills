...
Use $mf-web-scroll-progress-timeline to turn this ordered process into a responsive scroll story with one truthful progress line and readable active steps.

## Recreate the demo

Use $mf-web-scroll-progress-timeline to recreate **Fieldwork — From Question to Proof** as a complete standalone HTML document. Treat `demo/index.html` as the visual, interaction, responsive, accessibility, and performance reference.
