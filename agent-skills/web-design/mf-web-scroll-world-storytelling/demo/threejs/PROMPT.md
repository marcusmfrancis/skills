...
Use $mf-web-scroll-world-storytelling in **Three.js world** mode to create a responsive standalone landing page titled The Contract: One Coherent Object.
