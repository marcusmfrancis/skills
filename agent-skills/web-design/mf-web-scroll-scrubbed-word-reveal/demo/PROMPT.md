...
Use $mf-web-scroll-scrubbed-word-reveal to make this marked-up passage become readable word by word as the reader scrolls.

## Recreate the demo

Use $mf-web-scroll-scrubbed-word-reveal to recreate **A Field Note on Attention** as a complete standalone HTML document. Treat `demo/index.html` as the visual, interaction, responsive, accessibility, and performance reference.
...
Use $mf-web-scroll-scrubbed-word-reveal and the included demo as the quality bar, but replace the passage, typography, palette, accent markup, and pacing. Preserve semantic inline markup, responsive wrapping, normalized reversible progress, reduced-motion readability, and teardown safety.
