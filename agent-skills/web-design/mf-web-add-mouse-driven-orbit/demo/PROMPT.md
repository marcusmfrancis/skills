...
```text
Use $mf-web-add-mouse-driven-orbit to give this Three.js hero restrained pointer depth without turning it into a draggable product viewer.
```

## Recreate the demo

Use `$mf-web-add-mouse-driven-orbit` to recreate **Sylva — Living Orbit** as a standalone local HTML demo.
