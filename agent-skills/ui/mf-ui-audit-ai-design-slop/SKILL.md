---
name: mf-ui-audit-ai-design-slop
...
For a full-page or full-site review, read [references/no-ai-design-slop.md](references/no-ai-design-slop.md) and use only the catalog sections relevant to the inspected artifact. Do not turn every checklist match into a finding. Group symptoms by root cause and report the highest-impact evidence.
