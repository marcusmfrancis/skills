...
Personal-brand library owned by Marcus M Francis. Skill folders and frontmatter names begin with mf-. Group related topics using mf-category-skill-name. Keep every skill portable; no machine-specific paths, credentials or private client artifacts.
